...
class Unit_Core_oxLegacyDbTest extends OxidTestCase
{
    ...
    public function testSetConnection()
    {
        ...
        $this->assertNotNull($oLegacyDb->_getDb(false));
    }
    ...
    public function testExecute()
    {
        ...
        $oLegacyDb = $this->getMock("oxLegacyDb", array("_getDb"));
        $oLegacyDb->expects($this->once())->method('_getDb')->with($this->equalTo(false))->will($this->returnValue($oDbLib));
    ...
    public function testQuote()
    {
        ...
        $oLegacyDb = $this->getMock("oxLegacyDb", array("_getDb"));
        $oLegacyDb->expects($this->once())->method('_getDb')->will($this->returnValue($oDbLib));
    ...
    public function testSetTransactionIsolationLevelBadName()
    {
        ...
        $oLegacyDb = $this->getMock("oxLegacyDb", array("_getDb"));
        $oLegacyDb->expects($this->never())->method("_getDb");
