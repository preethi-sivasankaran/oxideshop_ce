                    ...
                    for ($i = 0; $i < count($aQueries); $i++) {
                        ...
                        if ($oStr->strlen($sUpdateSQL) > 0) {
                            ...
                            try {
                                ...
                                $aQAffectedRows[$iQueriesCounter] = $oDB->affected_Rows();
                            } catch (Exception $oEx) {
                                // Report errors
                                $aQErrorMessages[$iQueriesCounter] = oxStr::getStr()->htmlentities($oEx->getMessage());
                                $aQErrorNumbers[$iQueriesCounter] = oxStr::getStr()->htmlentities($oEx->getCode());
